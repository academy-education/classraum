            ...
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                >
                  ...
                  {unreadCount > 0 && (
                    <span className="absolute -top-0.5 -right-0.5 min-w-[12px] h-3 bg-primary text-white text-[10px] rounded-full flex items-center justify-center px-0.5 transition-opacity duration-200">
