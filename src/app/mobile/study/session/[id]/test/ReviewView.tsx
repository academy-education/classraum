    ...
    <div className="flex-1 overflow-y-auto" style={{ overscrollBehavior: 'contain' }}>
      <TestResultView
        ...
        footer={
          <Link
            href="/mobile/study"
            className="w-full lg:w-auto lg:min-w-[200px] inline-flex items-center justify-center h-11 rounded-full bg-white ring-1 ring-gray-200/70 text-[15px] font-medium text-gray-700"
          >
