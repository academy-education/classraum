...
export function StudyScrollShell({
  ...
  return (
    <div className={`flex flex-col h-full ${bg}`}>
      {/* Scroll container + pull-to-refresh gesture, spinner and drag
          translation all live in <PullToRefresh> — the single shared
          implementation. See its doc comment before changing the feel. */}
