      ...
      return NextResponse.json({
        ...
        data: {
          subscription: {
            ...
            autoRenew: false,
            billingKeyActive: false,
            totalUserLimit: freePlan.limits.totalUserLimit,
    ...
    return NextResponse.json({
      ...
      data: {
        subscription: {
          ...
          billingKeyActive: subscription.billingKeyActive ?? false,
          totalUserLimit: subscription.totalUserLimit,
