...
어려운 이유: 'Dismissed'에는 흔한 일상 의미(보기 1: '해고')가 있으나 여기서는 오답. 학술 맥락 — 공식 살롱 심사·조롱·후일의 반전 — 은 '진지한 주목을 받을 가치 없다고 배척되다'의 의미를 요구. 사전 1번 의미가 아닌 어조 민감 어휘 평가.`,
      ...
      },
      {
        ...
        choiceCount: 4,
        patterns_en: 'JANUARY 2026 FORMAT — a Listening module mixes THREE task types. Without audio playback in our app, render every transcript inline in the prompt (label it "Transcript:") so the student reads what they would have heard, then ask the question. Per 16-question module:\n  • TASK A — "Listen and Choose a Response" (~8 items, 50%): A single utterance (a question, statement, or short request) is read aloud. The student picks the most natural conversational reply. Transcript = ONE short line of 8-25 words from one speaker (e.g., "I can\'t believe how heavy this box is — can you give me a hand?"). 4 choices, each a plausible spoken reply; the correct one is the most natural register/function match. Topics: everyday campus, work, travel, social.\n  • TASK B — "Listen to a Conversation" (~4 items, 25%): A short 8-12 turn dialogue (~150-220 words total) between 2 speakers — student↔advisor, student↔librarian, roommates, professor↔student during office hours. 2-3 MC questions per conversation: gist, detail, function ("Why does the man say X?"), attitude.\n  • TASK C — "Listen to announcements and academic talks" (~4 items, 25%): A short announcement (~120-180 words: campus PA, transit, museum, library) OR a short academic mini-lecture (~180-260 words) on intro-level biology/history/psychology/business/geology/linguistics. 2-3 MC questions: main idea, key detail, speaker purpose, inference.\nMark each item\'s prompt with a tag like "[Choose a Response]", "[Conversation — Office hours]", or "[Lecture — Biology]" so the student knows the task type.',
        patterns_ko: '2026년 1월 형식 — 리스닝 모듈은 세 가지 과제 혼합. 앱에 오디오 재생이 없으므로 모든 전사를 프롬프트 내부에 "Transcript:"로 명시 후 문항 제시. 16문항 모듈 기준:\n  • 과제 A — "듣고 응답 고르기" (약 8문항, 50%): 한 화자가 짧은 한 줄(질문·진술·요청, 8-25단어)을 말하면 가장 자연스러운 응답을 선택. 보기 4개 모두 그럴듯한 구어 응답, 정답은 어조·기능이 가장 잘 맞는 것. 주제: 일상 캠퍼스·직장·여행·사교.\n  • 과제 B — "대화 듣기" (약 4문항, 25%): 두 화자의 짧은 8-12턴 대화(총 150-220단어) — 학생↔조언자, 학생↔사서, 룸메이트, 교수 상담. 대화당 2-3 MC: 요지, 세부, 기능("남자가 왜 X라고 말했는가?"), 태도.\n  • 과제 C — "공지와 학술 강의 듣기" (약 4문항, 25%): 짧은 공지(120-180단어: 캠퍼스 안내방송·교통·박물관·도서관) 또는 짧은 미니 강의(180-260단어, 입문 생물·역사·심리·경영·지질·언어학). 2-3 MC: 주제, 핵심 세부, 화자 목적, 추론.\n프롬프트에 과제 태그 부여: "[응답 고르기]", "[대화 — 교수 상담]", "[강의 — 생물학]" 등.',
