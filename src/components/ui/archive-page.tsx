  ...
  return (
    <div className="p-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        <div>
          <p className="hidden sm:block text-2xs font-semibold uppercase tracking-[0.12em] text-primary mb-1.5">{t("eyebrows.archive")}</p>
          <h1 className="text-xl sm:text-3xl font-semibold tracking-tight text-gray-900">{t("archive.title")}</h1>
          <p className="hidden sm:block text-gray-500">{t("archive.description")}</p>
        </div>
      </div>
