#!/usr/bin/env node
/**
 * Options-only attack render for act-math-v14-mix, with a MATCHED LIVE CONTROL
...
const batch = JSON.parse(readFileSync('scripts/study-bank/act-math-v14-mix.batch.json', 'utf8'))
...
const EXCLUDE_COHORTS = new Set(['act-math-v13-ies'])
...
writeFileSync('scripts/study-bank/v14-attack.blind.json', JSON.stringify(blind, null, 1) + '\n')
writeFileSync('scripts/study-bank/v14-attack.key.json', JSON.stringify(key, null, 1) + '\n')
