...

  {
    ...
    items: [
      ...
      { d: 'Production of Writing', s: 'purpose of the essay', f: 'hard', k: 0,
        ...
        c: ['Yes, because it explains the banding, follows one animal through its feeding, and closes with specific instructions for visitors.',
          'Yes, because it warns visitors that the tide will cover the shelf again within the hour.',
          'No, because it describes the pools without ever naming a species a visitor could find.',
...

  {
    ...
    items: [
      { d: 'Conventions of Standard English', s: 'illogical comparison', f: 'medium', k: 2,
        ...
        c: ['No Change', 'is not like lectures.', 'is not like interpreting a lecture.', 'is not like a lecture is.'],
        e: 'The sentence compares an activity to a thing, so an act of interpreting has to sit on both sides of "like." Switching to the plural "lectures" leaves the same mismatch, and adding "is" at the end makes the mismatch explicit rather than repairing it.' },
      ...
      { d: 'Production of Writing', s: 'relevance of a detail', f: 'medium', k: 1,
        ...
        c: ['Kept, because it identifies the woman on the platform as one of the fourteen people mentioned in paragraph 1.',
          'Kept, because it ends the profile with an exchange, showing the interpreter as a participant rather than as equipment.',
          'Deleted, because the essay has already described the thank-you and repeating it slows the ending.',
      ...
      { d: 'Production of Writing', s: 'purpose of the essay', f: 'hard', k: 3,
        ...
        c: ['No, because the essay describes a single night and one unlisted cover instead of a season of work.',
          'No, because the essay reports how many hours Ruiz spends preparing without saying what she does during them.',
          'Yes, because the essay states in its first sentence that Ruiz has studied the set list for a week.',
          'Yes, because it shows twenty hours of preparation, decisions about spelling and space, and a reading of what the platform wants.'],
...

  {
    ...
    items: [
      ...
      { d: 'Production of Writing', s: 'relevance of a detail', f: 'medium', k: 0,
        ...
        c: ['Kept, because it records the one part of the cost objection that the council was able to answer, which is why the paragraph turns next to memory.',
      ...
      { d: 'Production of Writing', s: 'effective conclusion', f: 'hard', k: 3,
        ...
        c: ['No Change',
          'and the plaques were installed the following spring',
    ...
    items: [
      ...
      { d: 'Production of Writing', s: 'purpose of the essay', f: 'hard', k: 3,
        ...
        c: ['No, because the essay attributes the station\'s survival mainly to Ossie Pratt and the founders rather than to its listeners.',
          ...
          'Yes, because the pledge drives, the 600 listeners who replaced the transmitter, and the closing line about whoever fills an hour all tie survival to the audience.'],
